  ...
  return (
    <div className="space-y-8">
      ...
      <CollapsibleSection title="Recalls & Maintenance">
        {maintenance.data ? <MaintenanceList items={maintenance.data} /> : <ListSkeleton rows={4} />}
      </CollapsibleSection>

      <CollapsibleSection title="Known Issues for Your Model">
        {issues.data ? <KnownIssuesList issues={issues.data} /> : <ListSkeleton rows={3} />}
      </CollapsibleSection>

      <CollapsibleSection title="Service & Repair History">
        {history.data ? <ServiceHistory records={history.data} /> : <ListSkeleton rows={5} />}
      </CollapsibleSection>
