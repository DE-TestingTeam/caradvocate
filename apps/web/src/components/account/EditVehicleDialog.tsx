    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* The zip moved to Edit profile -- it says where the owner is, not what the car is,
              even though it is stored on the vehicle row. Kept in one place so the two dialogs
              cannot show different answers for the same field. */}
          {canAddVin && (
            <div className="space-y-2">
